...
const pipe = (...fcts) => initialValue => fcts.reduce((acc, fct)=> fct(acc),initialValue);
...
const pipeAndLog = pipe(add10,trace('after add10'),squareIt,trace('after squareIt'),divideBy2,trace('after divideBy2'));
